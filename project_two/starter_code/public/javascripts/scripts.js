$(function(){
  picture()
  function picture(){
    $("#marquee").html("<marquee class='banner'>WELCOME TO YOUR INTERNATIONAL PHONEBOOK!!! CLICK THE GLOBE TO CONTINUE!! ALL RED WORDS ARE DRAGGABLE</marquee")
      ...
      $.get("/contacts", function(contacts){
        for(var i = 0; i < contacts.length; i ++){
           if (contacts[i].name == searchWord){
            var innards ="<li><a href='#' id='" + contacts[j].id +"' class='contact'>" + contacts[i].name.toUpperCase() + "</a></li>"
